...
def get_odds():
        ...
        if event['id'] == '6735058':
            ...
            for market in markets:
                ...
                for outcome in outcomes:
                    ...
                    for price in prices:
                        size = str(price['decimal'])
                        km_to_go = kmtogo.get()

                        entry = (None, 'Oddset', race, rider, size, timestamp, km_to_go)
    ...
    print(kmtogo.get() + "km to go  -  Odds changed:", odds_changed)
    logging.info(kmtogo.get() + "km to go  -  Odds changed: " + str(odds_changed))
...
#    updates += 1
#    get_odds()
#    print(kmtogo.get() + "km to go  -  Updated", updates, "times")
#    time.sleep(30)

db.table_of('Milano-Sanremo: Vinder')
